...
This Action runs on every PR in the `open-delivery-spec` org with the
[open-source disclosure policy](https://open-delivery-spec.github.io/spec/oss-ai-policy.html)
and review routing on (dogfooding; this repository's own copy is
[`.ods/policy.rego`](.ods/policy.rego)), and in external repositories including [devops-maturity](https://github.com/devops-maturity/devops-maturity) and [conventional-branch](https://github.com/conventional-branch/conventional-branch). See [ADOPTERS.md](https://github.com/open-delivery-spec/spec/blob/main/ADOPTERS.md) for the current list.
