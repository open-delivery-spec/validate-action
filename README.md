...
> stable release** of the ODS CLI (`cli-ref: v0.7.3`) so runs are reproducible.
...
> - uses: open-delivery-spec/validate-action@v1
>   with:
>     cli-ref: main   # latest; or a specific tag/commit like v0.7.3
> ```
...
| `cli-ref` | No | `v0.7.3` | ODS CLI version/tag/commit (`main` for latest) |
