...
> stable release** of the ODS CLI (`cli-ref: v0.7.4`) so runs are reproducible.
...
> - uses: open-delivery-spec/validate-action@v1
>   with:
>     cli-ref: main   # latest; or a specific tag/commit like v0.7.4
> ```
...
| `cli-ref` | No | `v0.7.4` | ODS CLI version/tag/commit (`main` for latest) |
